...
def main(args):
    ...
    dump_root = "/mnt/1.9TB/struct2depth/kitti_eigen_instance/"
    data_root = "/mnt/1.9TB/struct2depth/kitti_processed/"
    ...
    """
    with open(args.kitti_eigen_file, 'r') as f:
    ...
    im_list = [data_root + im.replace(" ", "/") + ".png" for im in im_list]
    #im_list = im_list[29700:30000]
    #im_list = im_list[38000:]
    """
    im_list = ["/detectron/result/rgb/0000000216.png",
                "/detectron/result/rgb/0000000072.png",
                "/detectron/result/rgb/0000000915.png",
                "/detectron/result/rgb/0000000951.png"]
    ...
    for i, im_name in enumerate(im_list):
        ...
        cv2.imwrite(os.path.join(dump_dir, '{}'.format(f + "-seg.png")), masks)
        """
